...
- (UIView *)hudView {
    ...
    if(!hudView) {
        ...
        if (@available(iOS 13.0, *)) {
            hudView.backgroundColor = [[UIColor systemGray2Color] colorWithAlphaComponent:0.8];
        } else {
...
- (UILabel *)stringLabel {
    if (stringLabel == nil) {
        ...
        if (@available(iOS 13.0, *)) {
            stringLabel.textColor = [UIColor labelColor];
        } else {
        ...
        if (@available(iOS 13.0, *)) {
            stringLabel.shadowColor = [UIColor systemGray2Color];
        } else {
